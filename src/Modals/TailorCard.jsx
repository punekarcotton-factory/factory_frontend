        ...
        {memo.tailorDetails && (
          ...
          >
            ...
            >
              ...
              >
                {memo.tailorDetails.name}
                {memo.tailorDetails.isActive === false && (
                  <Chip 
                    label="Deactivated" 
                    size="small" 
                    sx={{ 
            ...
            {memo.stageHistory?.find(h => h.stage === 'TASK_REASSIGNED') && (
              <Typography sx={{ fontSize: '11px', color: '#f59e0b', fontWeight: 600, mt: 0.5, fontStyle: 'italic' }}>
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 0.75 }}>
              ...
              <Typography sx={{ fontSize: "12px", color: "#475569" }}>
                {memo.tailorDetails.phoneNumber}
              </Typography>
            </Box>
          </Box>
        )}
